...
function transformBusiness(b: BackendBusiness): Business {
  return {
    ...
    data_tier: b.data_tier as Business['data_tier'],
    // Web scrape data
    web_scraped: b.web_scraped as boolean | undefined,
    web_scraped_at: b.web_scraped_at as string | undefined,
    web_raw_s3_key: b.web_raw_s3_key as string | undefined,
    web_extracted_s3_key: b.web_extracted_s3_key as string | undefined,
    web_pages_count: b.web_pages_count as number | undefined,
    web_scrape_method: b.web_scrape_method as Business['web_scrape_method'],
    web_total_bytes: b.web_total_bytes as number | undefined,
    web_scrape_duration_ms: b.web_scrape_duration_ms as number | undefined,
    web_scrape_errors: b.web_scrape_errors as number | undefined,
    web_scrape_status: b.web_scrape_status as Business['web_scrape_status'],
    // Extracted scrape data
    web_emails: b.web_emails as string[] | undefined,
    web_phones: b.web_phones as string[] | undefined,
    web_contact_page: b.web_contact_page as string | undefined,
    web_social_linkedin: b.web_social_linkedin as string | undefined,
    web_social_facebook: b.web_social_facebook as string | undefined,
    web_social_instagram: b.web_social_instagram as string | undefined,
    web_social_twitter: b.web_social_twitter as string | undefined,
    web_team_members: b.web_team_members as string | undefined,
    web_team_count: b.web_team_count as number | undefined,
    web_headcount_estimate: b.web_headcount_estimate as number | undefined,
    web_headcount_source: b.web_headcount_source as string | undefined,
    web_founded_year: b.web_founded_year as number | undefined,
    web_years_in_business: b.web_years_in_business as number | undefined,
    web_has_acquisition_signal: b.web_has_acquisition_signal as boolean | undefined,
    web_ownership_note: b.web_ownership_note as string | undefined,
  };
}
...
export interface ExportBusinessesResponse {
...
export const exportBusinesses = async (
...
): Promise<ExportBusinessesResponse> => {
  ...
  return apiClient<ExportBusinessesResponse>(`/businesses/export${queryString ? `?${queryString}` : ''}`, { requiresAuth: true });
};
